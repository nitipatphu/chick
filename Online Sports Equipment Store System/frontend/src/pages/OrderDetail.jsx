...
import { 
  ...
  CreditCard, Banknote, QrCode, Upload, X, Image, AlertCircle, 
  ...
  return (
    <div className="min-h-screen bg-sports-dark text-white pt-20 pb-20">
      <div className="container max-w-4xl mx-auto px-4">
        <Link to="/orders" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition mb-6">
