    ...
    <div className="min-h-screen bg-sports-dark text-white pt-20 pb-20">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link to="/staff/orders" className="glass-card text-center hover:border-sports-red">
            <div className="flex justify-center mb-2 text-sports-red"><ClipboardList size={32} /></div>
            <h3 className="font-bold">จัดการคำสั่งซื้อ</h3>
            <p className="text-gray-400 text-sm">ดูและอัปเดตสถานะคำสั่งซื้อของลูกค้า</p>
          </Link>
