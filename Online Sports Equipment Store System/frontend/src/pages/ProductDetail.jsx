          ...
          <div>
            ...
            <div className="mt-8 flex gap-4">
              {(!user || user.role === 'customer') ? (
                ...
                <div className="flex-1 bg-white/5 border border-white/10 rounded-xl py-4 text-center">
                  <p className="text-gray-400">⚠️ บัญชีผู้ดูแลระบบหรือพนักงานไม่สามารถสั่งซื้อสินค้าได้</p>
                </div>
              )}
            </div>
